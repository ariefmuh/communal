        ...
        <div class="row g-5 align-items-center">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="cta-image-wrapper">
              <img src="{{ asset('invent/assets/img/cta/cta-4.webp')}}" alt="Call to Action" class="img-fluid rounded-4">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
              <div class="portfolio-card">
                <div class="portfolio-image">
                  <img src="{{ asset('invent/assets/img/portfolio/portfolio-1.webp')}}" class="img-fluid" alt="" loading="lazy">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
              <div class="portfolio-card">
                <div class="portfolio-image">
                  <img src="{{ asset('invent/assets/img/portfolio/portfolio-10.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-actions">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-motion">
              <div class="portfolio-card">
                <div class="portfolio-image">
                  <img src="{{ asset('invent/assets/img/portfolio/portfolio-7.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-actions">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-brand">
              <div class="portfolio-card">
                <div class="portfolio-image">
                  <img src="{{ asset('invent/assets/img/portfolio/portfolio-4.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-actions">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
              <div class="portfolio-card">
                <div class="portfolio-image">
                  <img src="{{ asset('invent/assets/img/portfolio/portfolio-2.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-actions">
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
              <div class="portfolio-card">
                <div class="portfolio-image">
                  <img src="{{ asset('invent/assets/img/portfolio/portfolio-11.webp')}}" class="img-fluid" alt="" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-actions">
              ...
              <div class="testimonial-card">
                ...
                <div class="testimonial-profile">
                  ...
                  <div class="profile-info">
                    <img src="{{ asset('invent/assets/img/person/person-m-8')}}.webp" alt="Profile Image">
                    <div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card">
                ...
                <div class="testimonial-profile">
                  ...
                  <div class="profile-info">
                    <img src="{{ asset('invent/assets/img/person/person-f-3')}}.webp" alt="Profile Image">
                    <div>
                      <h3>Lisa Williams</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card">
                ...
                <div class="testimonial-profile">
                  ...
                  <div class="profile-info">
                    <img src="{{ asset('invent/assets/img/person/person-f-10')}}.webp" alt="Profile Image">
                    <div>
                      <h3>Emma Parker</h3>
                      <h4>UX Designer</h4>
                    </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card">
                ...
                <div class="testimonial-profile">
                  ...
                  <div class="profile-info">
                    <img src="{{ asset('invent/assets/img/person/person-m-5')}}.webp" alt="Profile Image">
                    <div>
                      <h3>David Miller</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card">
                ...
                <div class="testimonial-profile">
                  ...
                  <div class="profile-info">
                    <img src="{{ asset('invent/assets/img/person/person-m-2')}}.webp" alt="Profile Image">
                    <div>
                      <h3>Michael Davis</h3>
                      <h4>CEO &amp; Founder</h4>
                    </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card">
                ...
                <div class="testimonial-profile">
                  ...
                  <div class="profile-info">
                    <img src="{{ asset('invent/assets/img/person/person-f-7')}}.webp" alt="Profile Image">
                    <div>
