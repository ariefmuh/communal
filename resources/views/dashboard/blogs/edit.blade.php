...
<article style="text-align: justify;">
    ...
    <header class="mb-4">
        ...
        <div class="text-muted fst-italic mb-2">Posted on {{ Carbon::parse($blog->created_at)->format('M d, Y')}} by <span id="author">{{ $blog->author }}</span> <a class="badge bg-secondary text-decoration-none link-light" href="#!" data-bs-toggle="modal" data-bs-target="#editAuthorModal"><i class="fas fa-pencil-alt"></i></a></div>
        <div class="mb-2">
            <span id="tags">
                @foreach ($tags as $t)
    ...
    <div class="blog-section" id="sections">
        ...
        <div class="mb-4" id="sections-{{ $s->id }}">
            ...
            <button class="btn btn-danger" onclick="removeSection({{ $s->id }})">Remove</button>
        </div>
        @endforeach
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="newAuthor" placeholder="Enter new author" value="{{ $blog->author }}">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="newTags" placeholder="Enter new tags (comma separated)" value="{{ implode(',', $tags->pluck('name_tag')->toArray()) }}">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        ...
        $(document).ready(function() {
            ...
            $('#saveNewSection').click(function() {
                ...
                if (newSectionTitle !== '' && newSectionDescription !== '') {
                    var newSectionHtml = `
                        <div class="blog-section" id="section-new-${newSectionId}">
