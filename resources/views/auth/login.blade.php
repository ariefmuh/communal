        ...
        <div class="bg-white rounded-lg shadow-lg flex overflow-hidden max-w-4xl">
            ...
            <div class="w-1/2 bg-white p-8 flex flex-col justify-center">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <!-- Password -->
                    <div class="mt-4">
                        <input class="w-full px-3 py-2 border border-green-700 rounded bg-gray-200 text-black-300 focus:outline-none focus:border-gray-500 @error('password') border-red-500 @enderror" id="password" placeholder="password" type="password" name="password" required/>
                        @error('password')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
