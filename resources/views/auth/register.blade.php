        ...
        <div class="bg-white rounded-lg shadow-lg flex overflow-hidden max-w-4xl">
            ...
            <div class="w-1/2 bg-white p-8 flex flex-col justify-center">
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        <input class="w-full px-3 py-2 border border-green-700 rounded bg-gray-200 text-black-300 focus:outline-none focus:border-gray-500 " id="no_wa" placeholder="Nomor WhatsApp" type="text" name="no_wa" value="{{ old('no_wa') }}" required autofocus oninput="this.value = this.value.replace(/[^0-9]/g, '')"/>
                    </div>

                    <div class="mt-4">
                        <input class="w-full px-3 py-2 border border-green-700 rounded bg-gray-200 text-black-300 focus:outline-none focus:border-gray-500 " id="email" placeholder="Email" type="email" name="email" value="{{ old('email') }}" required autofocus/>
                    </div>

                    <div class="mt-4">
                        <input class="w-full px-3 py-2 border border-green-700 rounded bg-gray-200 text-black-300 focus:outline-none focus:border-gray-500 " id="alamat" placeholder="Alamat" type="text" name="alamat" value="{{ old('alamat') }}" required autofocus/>
                    </div>
